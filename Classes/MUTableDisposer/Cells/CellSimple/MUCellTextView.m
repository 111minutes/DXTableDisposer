...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        textView = [[MUTextView alloc] initWithFrame:CGRectZero];
...
- (void)setupCellData:(MUCellData *)aCellData
{
    ...
    CGFloat titleHeight = cellDataTextView.titleFont.lineHeight;
    ...
    // title
    _titleLabel.frame = CGRectMake(10, 0, self.bounds.size.width - 20, titleHeight);
    _titleLabel.text = cellDataTextView.title;
    _titleLabel.textColor = cellDataTextView.titleColor;
    _titleLabel.font = cellDataTextView.titleFont;
